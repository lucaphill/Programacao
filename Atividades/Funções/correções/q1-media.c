...
// }
/*
A função estava escrita com 'int' então ela automaticamente convertia os valores para inteiros, tirando o que vinha depois da virgula, isso em todos os seus paramentros, desde sua definição até a soma.

Trocando suas definições para float, a conta passa a dar certo
*/
